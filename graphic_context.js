export class GraphicContext {
    ...
    drawImage(texture = {source: null, width: 0, height: 0}, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight) {}
...
export class WebGlContext extends GraphicContext {
    ...
    drawImage(texture, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight) {
        this.gl.bindTexture(this.gl.TEXTURE_2D, texture.source);

        const { texSx, texSy, texSWidth, texSHeight } = this.normalizeTextureCoordinates(texture.width, texture.height, sx, sy, sWidth, sHeight);
